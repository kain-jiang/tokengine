...
type UserSetting struct {
	...
	NotificationPhone                string  `json:"notification_phone,omitempty"`                   // NotificationPhone 短信通知手机号码
	...
	RecordIpLog                      *bool   `json:"record_ip_log,omitempty"`                        // 是否记录请求和错误日志IP（nil 表示未设置，默认开启）
