...
const FooterBar = () => {
  ...
  const customFooter = useMemo(
    () => (
      <footer
        className={`relative h-auto ${isDemoSiteMode ? 'py-16' : 'py-8'} px-6 md:px-24 w-full flex flex-col items-center justify-between overflow-hidden bg-dark-blue text-white border-t border-semi-color-border`}
      >
        {isDemoSiteMode && (
  ...
  return (
    <div className='w-full'>
      {footer ? (
        <footer className='relative h-auto py-8 px-6 md:px-24 w-full flex items-center justify-center overflow-hidden bg-dark-blue text-white border-t border-semi-color-border'>
