	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/zefeng/oauth/token", controller.GetZefengOAuthToken)
		...
		financeRoute.Use(middleware.AdminAuth())
		{
			...
			financeRoute.GET("/orders/chart-data", controller.GetOrderChartStatistics)
			financeRoute.GET("/orders/export", controller.ExportOrders)
			financeRoute.GET("/reports", controller.GetRevenueReports)
			financeRoute.GET("/reports/export", controller.ExportRevenueReports)
			financeRoute.GET("/trend", controller.GetRevenueTrend)
			financeRoute.GET("/users/:id/revenue", controller.GetUserRevenueDetail)
			...
			financeRoute.GET("/revenue-management/dashboard", controller.GetRevenueManagementDashboard)
		}
		...
		modelsRoute.Use(middleware.AdminAuth())
		{
			...
			modelsRoute.GET("/blacklist", controller.GetBlacklistedModels)
